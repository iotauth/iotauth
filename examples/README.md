...
3. You will be prompted to enter password for keystores of Auths. Enter your password to proceed.
...
For more Node.js example entities, see [`entity/node/example_entities/README.md`](../entity/node/example_entities/README.md).
