...
async function main() {
    const tests = [
        ["configs/net1/node0.config", "DelegationRevoke", "Node1", "ResourceA", "1*day"],
        ["configs/net1/node0.config", "DelegationRevoke", "Node1", "ResourceB", "1*day"],
        ["configs/net1/node0.config", "DelegationRevoke", "Node2", "ResourceC", "1*day"],
        ["configs/net1/node0.config", "DelegationRevoke", "Node2", "ResourceD", "1*day"],
    ];
