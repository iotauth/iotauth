...
//clientÔøΩÔøΩ ÔøΩÃøÔøΩÔøΩÔøΩ.
//configÔøΩÔøΩ ÔøΩ øÔøΩÔøΩ—∞ÔøΩ: IP_ADDRESS PORT_NUM sender purpose num_key
...
{
    unsigned char encrypted[256]; // embedded system?óê?Ñú?äî Î¨∏Ï†úÍ∞? ?ê† ?àò ?ûà?ùå 
...
//session_key∏¶ ø©∑Ø∞≥ πﬁ∞ÌΩÕæÓø‰. struct  ±∏¡∂? return?'
/*
    config = load_config();
