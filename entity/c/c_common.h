...
void num_to_var_length_int(unsigned int data_length, unsigned char *payload_buf, unsigned char *payload_buf_length);
...
// May be the entity_client-Auth, entity_client - entity_server, entity_server - Auth.
