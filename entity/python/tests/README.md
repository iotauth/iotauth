...
- `test_public_key_request_mode_sends_public_encrypted_message` verifies that an entity without a distribution key sends the public-key-protected session-key request type.
