...
public class SslConnectionFactory extends org.eclipse.jetty.server.AbstractConnectionFactory
{
    ...
    @Override
    public Connection newConnection(org.eclipse.jetty.server.Connector connector, EndPoint endPoint)
    {
    ...
    protected SslConnection newSslConnection(org.eclipse.jetty.server.Connector connector, EndPoint endPoint, SSLEngine engine)
    {
