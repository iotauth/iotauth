 ...
 */
public class HttpChannelOverHttp extends org.eclipse.jetty.server.HttpChannel implements HttpParser.RequestHandler, HttpParser.ComplianceHandler
{
     ...
     * <p>The upgrade looks up a {@link org.eclipse.jetty.server.ConnectionFactory.Upgrading} from the connector
    ...
    private boolean upgrade() throws BadMessageException
    {
        ...
        org.eclipse.jetty.server.ConnectionFactory.Upgrading factory = null;
        for (org.eclipse.jetty.server.ConnectionFactory f : getConnector().getConnectionFactories())
        {
            if (f instanceof org.eclipse.jetty.server.ConnectionFactory.Upgrading)
            {
