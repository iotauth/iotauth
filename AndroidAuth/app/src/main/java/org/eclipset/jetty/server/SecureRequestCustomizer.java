 ...
 */
public class SecureRequestCustomizer implements org.eclipse.jetty.server.HttpConfiguration.Customizer
{
    ...
    @Override
    public void customize(org.eclipse.jetty.server.Connector connector, HttpConfiguration channelConfig, org.eclipse.jetty.server.Request request)
    {
        EndPoint endp = request.getHttpChannel().getEndPoint();
        if (endp instanceof DecryptedEndPoint)
        {
            DecryptedEndPoint ssl_endp = (DecryptedEndPoint)endp;
        ...
        else if (endp instanceof org.eclipse.jetty.server.ProxyConnectionFactory.ProxyEndPoint)
        {
            org.eclipse.jetty.server.ProxyConnectionFactory.ProxyEndPoint proxy = (org.eclipse.jetty.server.ProxyConnectionFactory.ProxyEndPoint)endp;
     ...
     * The default impl calls {@link org.eclipse.jetty.server.Request#setSecure(boolean)} with true
     * and sets a response header if the Strict-Transport-Security options 
     * are set.
     * @param request the request being customized
     */
    protected void customizeSecure(org.eclipse.jetty.server.Request request)
    {
