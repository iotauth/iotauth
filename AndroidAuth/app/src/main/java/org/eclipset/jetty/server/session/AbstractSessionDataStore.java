...
public abstract class AbstractSessionDataStore extends ContainerLifeCycle implements SessionDataStore
{
    ...
    /** 
     * @see org.eclipse.jetty.server.session.SessionDataStore#store(String, org.eclipse.jetty.server.session.SessionData)
     */
    @Override
    ...
    /** 
     * @see org.eclipse.jetty.server.session.SessionDataStore#newSessionData(String, long, long, long, long)
     */
    @Override
