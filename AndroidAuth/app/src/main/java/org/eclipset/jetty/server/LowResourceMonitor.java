 ...
 * <ul>
 * <li>{@link ThreadPool#isLowOnThreads()} if {@link org.eclipse.jetty.server.Connector#getExecutor()} is
 ...
 * by {@link org.eclipse.jetty.server.Connector#getConnectedEndPoints()} have {@link EndPoint#setIdleTimeout(long)} set
 ...
 * cleared, the idle timeout is reset to the connector default given by {@link org.eclipse.jetty.server.Connector#getIdleTimeout()}.
 */
...
public class LowResourceMonitor extends AbstractLifeCycle
{
    ...
    public Collection<org.eclipse.jetty.server.Connector> getMonitoredConnectors()
    {
     ...
     */
    public void setMonitoredConnectors(Collection<org.eclipse.jetty.server.Connector> monitoredConnectors)
    {
        if (monitoredConnectors==null || monitoredConnectors.size()==0)
            _monitoredConnectors=null;
        else
            _monitoredConnectors = monitoredConnectors.toArray(new org.eclipse.jetty.server.Connector[monitoredConnectors.size()]);
    }
    ...
    protected void monitor()
    {
        ...
        for(org.eclipse.jetty.server.Connector connector : getMonitoredOrServerConnectors())
        {
