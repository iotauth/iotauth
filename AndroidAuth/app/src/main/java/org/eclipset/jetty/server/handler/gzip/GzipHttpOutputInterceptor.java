...
package org.eclipset.jetty.server.handler.gzip;
...
public class GzipHttpOutputInterceptor implements HttpOutput.Interceptor
{
    ...
    public GzipHttpOutputInterceptor(org.eclipse.jetty.server.handler.gzip.GzipFactory factory, HttpChannel channel, HttpOutput.Interceptor next, boolean syncFlush)
    {
        this(factory,VARY_ACCEPT_ENCODING_USER_AGENT,channel.getHttpConfiguration().getOutputBufferSize(),channel,next,syncFlush);
    }

    public GzipHttpOutputInterceptor(org.eclipse.jetty.server.handler.gzip.GzipFactory factory, HttpField vary, HttpChannel channel, HttpOutput.Interceptor next, boolean syncFlush)
    {
        this(factory,vary,channel.getHttpConfiguration().getOutputBufferSize(),channel,next,syncFlush);
    }

    public GzipHttpOutputInterceptor(org.eclipse.jetty.server.handler.gzip.GzipFactory factory, HttpField vary, int bufferSize, HttpChannel channel, HttpOutput.Interceptor next, boolean syncFlush)
    {
        _factory=factory;
        _channel=channel;
        _interceptor=next;
