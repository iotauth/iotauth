...
package org.eclipset.jetty.server.session;
...
public abstract class AbstractSessionCache extends ContainerLifeCycle implements SessionCache
{
     ...
     * 
     */
    public AbstractSessionCache (org.eclipse.jetty.server.session.SessionHandler handler)
    {
        _handler = handler;
    }
     ...
     * session manager.
     * 
     * @see org.eclipse.jetty.server.session.SessionCache#get(String)
     */
    @Override
     ...
     * 
     * @see org.eclipse.jetty.server.session.SessionCache#put(String, org.eclipse.jetty.server.session.Session)
     */
    @Override
     ...
     * 
     * @see org.eclipse.jetty.server.session.SessionCache#exists(String)
     */
    @Override
     ...
     * 
     * @see org.eclipse.jetty.server.session.SessionCache#contains(String)
     */
    @Override
     ...
     * 
     * 
     * @see org.eclipse.jetty.server.session.SessionCache#delete(String)
     */
    @Override
    ...
    /** 
     * @see org.eclipse.jetty.server.session.SessionCache#renewSessionId(String, String)
     */
    ...
    /** 
     * @see org.eclipse.jetty.server.session.SessionCache#newSession(HttpServletRequest, String, long, long)
     */
    @Override
