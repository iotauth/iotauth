...
public abstract class NegotiatingServerConnection extends AbstractConnection
{
    ...
    protected NegotiatingServerConnection(org.eclipse.jetty.server.Connector connector, EndPoint endPoint, SSLEngine engine, List<String> protocols, String defaultProtocol)
    {
    ...
    protected org.eclipse.jetty.server.Connector getConnector()
    {
        return connector;
    }
    ...
    public void onFillable()
    {
        ...
        if (filled == 0)
        {
            ...
            {
                org.eclipse.jetty.server.ConnectionFactory connectionFactory = connector.getConnectionFactory(protocol);
