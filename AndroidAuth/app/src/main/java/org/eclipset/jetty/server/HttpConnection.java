...
public class HttpConnection extends AbstractConnection implements Runnable, HttpTransport, Connection.UpgradeFrom
{
    ...
    public HttpConnection(org.eclipse.jetty.server.HttpConfiguration config, org.eclipse.jetty.server.Connector connector, EndPoint endPoint, HttpCompliance compliance, boolean recordComplianceViolations)
    {
    ...
    {
        return new org.eclipse.jetty.server.HttpChannelOverHttp(this, _connector, _config, getEndPoint(), this);
    }
