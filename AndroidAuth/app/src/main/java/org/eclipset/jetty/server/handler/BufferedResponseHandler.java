 ...
 * </p>
 */
public class BufferedResponseHandler extends org.eclipse.jetty.server.handler.HandlerWrapper
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see org.eclipse.jetty.server.handler.HandlerWrapper#handle(String, Request, HttpServletRequest, HttpServletResponse)
     */
    @Override
