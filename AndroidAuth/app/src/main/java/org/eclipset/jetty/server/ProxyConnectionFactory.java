 ...
 */
public class ProxyConnectionFactory extends org.eclipse.jetty.server.AbstractConnectionFactory
{
    ...
    @Override
    public Connection newConnection(org.eclipse.jetty.server.Connector connector, EndPoint endp)
    {
        String next=_next;
        if (next==null)
        {
    ...
    public class ProxyProtocolV1orV2Connection extends AbstractConnection
    {
        ...
        protected ProxyProtocolV1orV2Connection(EndPoint endp, org.eclipse.jetty.server.Connector connector, String next)
        {
    ...
    public static class ProxyProtocolV1Connection extends AbstractConnection
    {
        ...
        protected ProxyProtocolV1Connection(EndPoint endp, org.eclipse.jetty.server.Connector connector, String next, ByteBuffer buffer)
        {
            super(endp,connector.getExecutor());
            _connector=connector;
            _next=next;
        ...
        public void onFillable()
        {
            try
            {
                ...
                org.eclipse.jetty.server.ConnectionFactory connectionFactory = _connector.getConnectionFactory(_next);
