...
/**
 */
public class PushBuilderImpl implements org.eclipse.jetty.server.PushBuilder
{
    ...
    /* ------------------------------------------------------------ */
    @Override
    public org.eclipse.jetty.server.PushBuilder method(String method)
    {
        _method = method;
        return this;
    }
    ...
    /* ------------------------------------------------------------ */
    @Override
    public org.eclipse.jetty.server.PushBuilder queryString(String queryString)
    {
        _queryString = queryString;
        return this;
    }
    ...
    /* ------------------------------------------------------------ */
    @Override
    public org.eclipse.jetty.server.PushBuilder sessionId(String sessionId)
    {
        _sessionId = sessionId;
        return this;
    }
    ...
    /* ------------------------------------------------------------ */
    @Override
    public org.eclipse.jetty.server.PushBuilder conditional(boolean conditional)
    {
        _conditional = conditional;
        return this;
    }
    ...
    /* ------------------------------------------------------------ */
    @Override
    public org.eclipse.jetty.server.PushBuilder setHeader(String name, String value)
    {
    ...
    /* ------------------------------------------------------------ */
    @Override
    public org.eclipse.jetty.server.PushBuilder addHeader(String name, String value)
    {
    ...
    /* ------------------------------------------------------------ */
    @Override
    public org.eclipse.jetty.server.PushBuilder removeHeader(String name)
    {
        _fields.remove(name);
        return this;
    }
    ...
    /* ------------------------------------------------------------ */
    @Override
    public org.eclipse.jetty.server.PushBuilder path(String path)
    {
        _path = path;
        return this;
    }
    ...
    /* ------------------------------------------------------------ */
    @Override
    public org.eclipse.jetty.server.PushBuilder etag(String etag)
    {
        _etag = etag;
        return this;
    }
    ...
    /* ------------------------------------------------------------ */
    @Override
    public org.eclipse.jetty.server.PushBuilder lastModified(String lastModified)
    {
