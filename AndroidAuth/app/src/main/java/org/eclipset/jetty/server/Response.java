...
public class Response implements HttpServletResponse
{
    ...
    public Response(org.eclipse.jetty.server.HttpChannel channel, org.eclipse.jetty.server.HttpOutput out)
    {
        _channel = channel;
        _out = out;
    }
    ...
    {
        final org.eclipse.jetty.server.Request request = _channel.getRequest();
    ...
    public void sendError(int code, String message) throws IOException
    {
        ...
        org.eclipse.jetty.server.Request request = _channel.getRequest();
