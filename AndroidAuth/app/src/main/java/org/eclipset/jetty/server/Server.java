...
public class Server extends HandlerWrapper implements Attributes
{
    ...
    private final List<org.eclipse.jetty.server.Connector> _connectors = new CopyOnWriteArrayList<>();
     ...
     * @see org.eclipse.jetty.server.NetworkConnector#getLocalPort()
     */
    public Server(@Name("port")int port)
    {
        ...
        setConnectors(new org.eclipse.jetty.server.Connector[]{connector});
    }
    ...
    {
        List<org.eclipse.jetty.server.Connector> connectors = new ArrayList<>(_connectors);
        return connectors.toArray(new org.eclipse.jetty.server.Connector[connectors.size()]);
    }
    ...
    /* ------------------------------------------------------------ */
    /**
     * Convenience method which calls {@link #getConnectors()} and {@link #setConnectors(org.eclipse.jetty.server.Connector[])} to
     * remove a connector.
     * @param connector The connector to remove.
     */
    public void removeConnector(org.eclipse.jetty.server.Connector connector)
    {
    ...
    public void setConnectors(org.eclipse.jetty.server.Connector[] connectors)
    {
        ...
        org.eclipse.jetty.server.Connector[] oldConnectors = getConnectors();
    ...
    protected void doStart() throws Exception
    {
        ...
        for (org.eclipse.jetty.server.Connector connector : _connectors)
        {
            if (connector instanceof org.eclipse.jetty.server.AbstractConnector)
            {
                org.eclipse.jetty.server.AbstractConnector abstractConnector = (AbstractConnector)connector;
    ...
    {
        // start connectors last
        if (!(l instanceof org.eclipse.jetty.server.Connector))
            super.start(l);
    }
    ...
    protected void doStop() throws Exception
    {
        ...
        org.eclipse.jetty.server.Handler[] gracefuls = getChildHandlersByClass(Graceful.class);
     ...
     */
    public void handle(org.eclipse.jetty.server.HttpChannel channel) throws IOException, ServletException
    {
     ...
     */
    protected void handleOptions(org.eclipse.jetty.server.Request request, Response response) throws IOException
    {
    }
    ...
    /* ------------------------------------------------------------ */
    /**
     * @return The URI of the first {@link org.eclipse.jetty.server.NetworkConnector} and first {@link ContextHandler}, or null
     */
    public URI getURI()
    {
        org.eclipse.jetty.server.NetworkConnector connector=null;
        for (Connector c: _connectors)
        {
            if (c instanceof org.eclipse.jetty.server.NetworkConnector)
            {
