...
/**
 * This {@link org.eclipse.jetty.server.Connector} implementation is the primary connector for the
 * Jetty server over TCP/IP.  By the use of various {@link org.eclipse.jetty.server.ConnectionFactory} instances it is able
 ...
 * passed {@link org.eclipse.jetty.server.Server} instance, but all services may also be constructor injected
 ...
 * default to use a {@link org.eclipse.jetty.server.HttpConnectionFactory}.  If an non null {@link SslContextFactory}
...
public class ServerConnector extends AbstractNetworkConnector
{
     ...
     * @param server The {@link org.eclipse.jetty.server.Server} this connector will accept connection for.
     */
    public ServerConnector(
        @Name("server") org.eclipse.jetty.server.Server server)
    {
        this(server,null,null,null,-1,-1,new org.eclipse.jetty.server.HttpConnectionFactory());
    }
    ...
    {
        this(server,null,null,null,acceptors,selectors,new org.eclipse.jetty.server.HttpConnectionFactory());
    }
    ...
    public ServerConnector(
        ...
        @Name("acceptors") int acceptors,
        @Name("selectors") int selectors,
        @Name("factories") org.eclipse.jetty.server.ConnectionFactory... factories)
    {
    ...
    /**
     * <p>Construct a ServerConnector with a private instance of {@link org.eclipse.jetty.server.HttpConnectionFactory} as the primary protocol</p>.
     * @param server The {@link org.eclipse.jetty.server.Server} this connector will accept connection for.
    ...
    {
        this(server,null,null,null,-1,-1, org.eclipse.jetty.server.AbstractConnectionFactory.getFactories(sslContextFactory,new org.eclipse.jetty.server.HttpConnectionFactory()));
    }
    ...
    public ServerConnector(
        ...
        @Name("sslContextFactory") SslContextFactory sslContextFactory)
    {
        this(server,null,null,null,acceptors,selectors, org.eclipse.jetty.server.AbstractConnectionFactory.getFactories(sslContextFactory,new HttpConnectionFactory()));
    }
     ...
     *          the number of selector threads, or &lt;=0 for a default value. Selectors notice and schedule established connection that can make IO progress.
     * @param factories
     *          Zero or more {@link org.eclipse.jetty.server.ConnectionFactory} instances used to create and configure connections.
     */
    public ServerConnector(
