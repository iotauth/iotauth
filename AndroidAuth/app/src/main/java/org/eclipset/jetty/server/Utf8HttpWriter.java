...
/** OutputWriter.
 * A writer that can wrap a {@link org.eclipse.jetty.server.HttpOutput} stream and provide
 * character encodings.
 *
 ...
 */
public class Utf8HttpWriter extends org.eclipse.jetty.server.HttpWriter
{
    int _surrogate=0;

    /* ------------------------------------------------------------ */
    public Utf8HttpWriter(org.eclipse.jetty.server.HttpOutput out)
    {
        super(out);
    }
