...
public interface Connector extends LifeCycle, Graceful
{
     ...
     * @return the {@link org.eclipse.jetty.server.ConnectionFactory} associated with the protocol name
     */
    public org.eclipse.jetty.server.ConnectionFactory getConnectionFactory(String nextProtocol);
    

    public <T> T getConnectionFactory(Class<T> factoryType);
    
    /**
     * @return the default {@link org.eclipse.jetty.server.ConnectionFactory} associated with the default protocol name
     */
    public org.eclipse.jetty.server.ConnectionFactory getDefaultConnectionFactory();
    
    public Collection<org.eclipse.jetty.server.ConnectionFactory> getConnectionFactories();
