...
public class ContextHandler extends org.eclipse.jetty.server.handler.ScopedHandler implements Attributes, Graceful
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see org.eclipse.jetty.server.handler.ScopedHandler#doScope(String, Request, HttpServletRequest,
     *      HttpServletResponse)
     */
    @Override
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see org.eclipse.jetty.server.handler.ScopedHandler#doHandle(String, Request, HttpServletRequest,
     *      HttpServletResponse)
     */
    @Override
     ...
     * Context.
     * <p>
     * A partial implementation of {@link ServletContext}. A complete implementation is provided by the derived {@link ContextHandler}.
     * </p>
     *
     *
     */
