...
public class DebugListener extends AbstractLifeCycle implements ServletContextListener
{
    ...
    { 
        ...
        {
            String cname=findContextName(((org.eclipse.jetty.server.AsyncContextEvent)event).getServletContext());
            String rname=findRequestName(event.getAsyncContext().getRequest());
            log("!  ctx=%s r=%s onTimeout %s",cname,rname,((org.eclipse.jetty.server.AsyncContextEvent)event).getHttpChannelState());
        }
        ...
        public void onStartAsync(AsyncEvent event) throws IOException
        {
            String cname=findContextName(((org.eclipse.jetty.server.AsyncContextEvent)event).getServletContext());
            String rname=findRequestName(event.getAsyncContext().getRequest());
            log("!  ctx=%s r=%s onStartAsync %s",cname,rname,((org.eclipse.jetty.server.AsyncContextEvent)event).getHttpChannelState());
        }
        ...
        public void onError(AsyncEvent event) throws IOException
        {
            String cname=findContextName(((org.eclipse.jetty.server.AsyncContextEvent)event).getServletContext());
            String rname=findRequestName(event.getAsyncContext().getRequest());
            log("!! ctx=%s r=%s onError %s %s",cname,rname,event.getThrowable(),((org.eclipse.jetty.server.AsyncContextEvent)event).getHttpChannelState());
        }
        
        @Override
        public void onComplete(AsyncEvent event) throws IOException
        {
            org.eclipse.jetty.server.AsyncContextEvent ace=(org.eclipse.jetty.server.AsyncContextEvent)event;
    ...
    final ContextScopeListener _contextScopeListener = new ContextScopeListener()
    {
        @Override
