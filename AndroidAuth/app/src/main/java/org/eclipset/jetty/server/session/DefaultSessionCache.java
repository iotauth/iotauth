...
public class DefaultSessionCache extends AbstractSessionCache
{
     ...
     * @param manager
     */
    public DefaultSessionCache (org.eclipse.jetty.server.session.SessionHandler manager)
    {
        super (manager);
    }
    ...
    /** 
     * @see org.eclipse.jetty.server.session.AbstractSessionCache#doPutIfAbsent(String, org.eclipse.jetty.server.session.Session)
     */
    @Override
    ...
    /** 
     * @see org.eclipse.jetty.server.session.AbstractSessionCache#newSession(HttpServletRequest, org.eclipse.jetty.server.session.SessionData)
     */
    @Override
    ...
    /** 
     * @see org.eclipse.jetty.server.session.AbstractSessionCache#doReplace(String, org.eclipse.jetty.server.session.Session, org.eclipse.jetty.server.session.Session)
     */
    @Override
