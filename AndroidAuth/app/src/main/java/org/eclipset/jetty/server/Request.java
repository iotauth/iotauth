 ...
 * Jetty Request.
 * <p>
 * Implements {@link HttpServletRequest} from the <code>javax.servlet.http</code> package.
 * </p>
 * <p>
...
public class Request implements HttpServletRequest
{
    ...
    public static Request getBaseRequest(ServletRequest request)
    {
        ...
        Object channel = request.getAttribute(org.eclipse.jetty.server.HttpChannel.class.getName());
        if (channel instanceof org.eclipse.jetty.server.HttpChannel)
            return ((org.eclipse.jetty.server.HttpChannel)channel).getRequest();
    ...
    /* ------------------------------------------------------------ */
    public Request(org.eclipse.jetty.server.HttpChannel channel, org.eclipse.jetty.server.HttpInput input)
    {
        _channel = channel;
        _input = input;
    }
     ...
     * If-None-Match then the {@link org.eclipse.jetty.server.PushBuilderImpl#isConditional()} header is set
     * to true.
     * </ul>
     *
     ...
     */
    public org.eclipse.jetty.server.PushBuilder getPushBuilder()
    {
        if (!isPushSupported())
    ...
    {
        org.eclipse.jetty.server.HttpChannelState state = getHttpChannelState();
    ...
    public Object getAttribute(String name)
    {
        if (name.startsWith("org.eclipse.jetty"))
        {
            ...
            if (org.eclipse.jetty.server.HttpChannel.class.getName().equals(name))
                return _channel;
            if (org.eclipse.jetty.server.HttpConnection.class.getName().equals(name) &&
    ...
    {
        if (_authentication instanceof org.eclipse.jetty.server.Authentication.Deferred)
            setAuthentication(((org.eclipse.jetty.server.Authentication.Deferred)_authentication).authenticate(this));

        if (_authentication instanceof org.eclipse.jetty.server.Authentication.User)
            return ((org.eclipse.jetty.server.Authentication.User)_authentication).getAuthMethod();
        return null;
    }
    ...
    public Cookie[] getCookies()
    {
        ...
        {
            if (_cookies == null)
                _cookies = new org.eclipse.jetty.server.CookieCutter();
    ...
    public UserIdentity getUserIdentity()
    {
        ...
        if (_authentication instanceof org.eclipse.jetty.server.Authentication.User)
            return ((org.eclipse.jetty.server.Authentication.User)_authentication).getUserIdentity();
        return null;
    }

    /* ------------------------------------------------------------ */
    /**
     * @return The resolved user Identity, which may be null if the {@link org.eclipse.jetty.server.Authentication} is not {@link org.eclipse.jetty.server.Authentication.User} (eg.
     *         {@link org.eclipse.jetty.server.Authentication.Deferred}).
     */
    ...
    public Principal getUserPrincipal()
    {
        ...
        if (_authentication instanceof org.eclipse.jetty.server.Authentication.User)
        {
            UserIdentity user = ((org.eclipse.jetty.server.Authentication.User)_authentication).getUserIdentity();
    ...
    public boolean isUserInRole(String role)
    {
        ...
        if (_authentication instanceof org.eclipse.jetty.server.Authentication.User)
            return ((org.eclipse.jetty.server.Authentication.User)_authentication).isUserInRole(_scope,role);
        return false;
    }
    ...
    protected void recycle()
    {
        ...
        setAuthentication(org.eclipse.jetty.server.Authentication.NOT_CHECKED);
     ...
     */
    public void setAuthentication(org.eclipse.jetty.server.Authentication authentication)
    {
    ...
    public AsyncContext startAsync() throws IllegalStateException
    {
        ...
        org.eclipse.jetty.server.HttpChannelState state = getHttpChannelState();
        if (_async==null)
            _async=new org.eclipse.jetty.server.AsyncContextState(state);
        org.eclipse.jetty.server.AsyncContextEvent event = new org.eclipse.jetty.server.AsyncContextEvent(_context,_async,state,this,this,getResponse());
    ...
    public AsyncContext startAsync(ServletRequest servletRequest, ServletResponse servletResponse) throws IllegalStateException
    {
        ...
        org.eclipse.jetty.server.AsyncContextEvent event = new AsyncContextEvent(_context,_async,state,this,servletRequest,servletResponse);
    ...
    public boolean authenticate(HttpServletResponse response) throws IOException, ServletException
    {
        if (_authentication instanceof org.eclipse.jetty.server.Authentication.Deferred)
        {
            setAuthentication(((org.eclipse.jetty.server.Authentication.Deferred)_authentication).authenticate(this,response));
            return !(_authentication instanceof org.eclipse.jetty.server.Authentication.ResponseSent);
        }
    ...
    public void login(String username, String password) throws ServletException
    {
        if (_authentication instanceof org.eclipse.jetty.server.Authentication.Deferred)
        {
            _authentication=((org.eclipse.jetty.server.Authentication.Deferred)_authentication).login(username,password,this);
            if (_authentication == null)
                throw new org.eclipse.jetty.server.Authentication.Failed("Authentication failed for username '"+username+"'");
        }
        else
        {
            throw new org.eclipse.jetty.server.Authentication.Failed("Authenticated failed for username '"+username+"'. Already authenticated as "+_authentication);
        }
    }
    ...
    {
        if (_authentication instanceof org.eclipse.jetty.server.Authentication.User)
            ((org.eclipse.jetty.server.Authentication.User)_authentication).logout();
