...
public interface HandlerContainer extends LifeCycle
{
     ...
     */
    public org.eclipse.jetty.server.Handler[] getChildHandlersByClass(Class<?> byclass);
     ...
     */
    public <T extends org.eclipse.jetty.server.Handler> T getChildHandlerByClass(Class<T> byclass);
}
