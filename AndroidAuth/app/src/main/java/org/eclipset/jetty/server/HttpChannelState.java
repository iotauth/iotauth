...
public class HttpChannelState
{
    ...
    protected HttpChannelState(org.eclipse.jetty.server.HttpChannel channel)
    {
        _channel=channel;
        _state=State.IDLE;
    ...
    public void startAsync(org.eclipse.jetty.server.AsyncContextEvent event)
    {
    ...
    {
        org.eclipse.jetty.server.AsyncContextEvent event = null;
        try (Locker.Lock lock= _locker.lock())
        {
            switch (_state)
            {
    ...
    public void dispatch(ServletContext context, String path)
    {
        ...
        org.eclipse.jetty.server.AsyncContextEvent event;
        try(Locker.Lock lock= _locker.lock())
        {
            if (LOG.isDebugEnabled())
    ...
    {
        final List<AsyncListener> listeners;
        final org.eclipse.jetty.server.AsyncContextEvent event;
    ...
    protected void cancelTimeout(org.eclipse.jetty.server.AsyncContextEvent event)
    {
        if (event!=null)
    ...
    ContextHandler getContextHandler(org.eclipse.jetty.server.AsyncContextEvent event)
    {
        if (event!=null)
        {
    ...
    public ServletResponse getServletResponse(org.eclipse.jetty.server.AsyncContextEvent event)
    {
    ...
    void runInContext(org.eclipse.jetty.server.AsyncContextEvent event, Runnable runnable)
    {
