...
public class ManagedAttributeListener implements  ServletContextListener, ServletContextAttributeListener
{
    ...
    final org.eclipse.jetty.server.handler.ContextHandler _context;
    
    public ManagedAttributeListener(org.eclipse.jetty.server.handler.ContextHandler context, String... managedAttributes)
    {
        _context=context;
