...
public class DefaultHandler extends AbstractHandler
{
    ...
    public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
    {
        ...
        try (ByteArrayISO8859Writer writer = new ByteArrayISO8859Writer(1500);)
        {
            ...
            Handler[] handlers = server==null?null:server.getChildHandlersByClass(org.eclipse.jetty.server.handler.ContextHandler.class);

            for (int i=0;handlers!=null && i<handlers.length;i++)
            {
                org.eclipse.jetty.server.handler.ContextHandler context = (org.eclipse.jetty.server.handler.ContextHandler)handlers[i];
