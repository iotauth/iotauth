...
public class NetworkTrafficServerConnector extends ServerConnector
{
    ...
    {
        this(server, null, null, null, 0, 0, new org.eclipse.jetty.server.HttpConnectionFactory());
    }

    public NetworkTrafficServerConnector(Server server, org.eclipse.jetty.server.ConnectionFactory connectionFactory, SslContextFactory sslContextFactory)
    {
        super(server, sslContextFactory, connectionFactory);
    }

    public NetworkTrafficServerConnector(Server server, org.eclipse.jetty.server.ConnectionFactory connectionFactory)
    {
