 ...
 * </p>
 */
public class GzipHandler extends HandlerWrapper implements org.eclipse.jetty.server.handler.gzip.GzipFactory
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see HandlerWrapper#handle(String, Request, HttpServletRequest, HttpServletResponse)
     */
    @Override
